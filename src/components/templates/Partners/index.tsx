        ...
        <div className="w-full">
            <motion.div initial="hidden" whileInView="show" viewport={{
                ...
                <motion.p variants={{
                    ...
                    Agradecemos aos nossos parceiros! Com o apoio deles, tornamos este evento possível. Confira quem são esses parceiros incríveis!
                </motion.p>
            </motion.div>
            ...
            <div className="relative -mt-32 md:-mt-48 lg:-mt-60 2xl:-mt-96">
                ...
                <motion.div initial="hidden" whileInView="show" viewport={{
                    ...
                    }} className="text-white font-bold text-28 leading-8 lg:text-60 lg:leading-65">Mantenedores</motion.h4>
                ...
                <svg id="wave-partners" className="rotate-0 duration-300" viewBox="0 0 1440 250" version="1.1" xmlns="http://www.w3.org/2000/svg">
                    <defs>
                        <linearGradient id="sw-gradient-wave-partners" x1="0" x2="0" y1="1" y2="0">
                            ...
                            <stop stop-color="rgba(10, 10, 10, 1)" offset="100%"></stop>
                        </linearGradient>
                    </defs>
