...
export default function Partners() {
    ...
    return (
        <div className="w-full bg-white h-auto z-10">
            ...
            <div className="mt-8 relative">
                <svg id="wave-shadow" className="rotate-0 duration-300 absolute -top-2" viewBox="0 0 1440 250" version="1.1" xmlns="http://www.w3.org/2000/svg">
                    <defs>
                        <linearGradient id="sw-gradient-wave-master-shadow" x1="0" x2="0" y1="1" y2="0">
                            <stop stopColor="rgba(0,0,0,.25)" offset="0%"></stop>
                            <stop stopColor="rgba(0,0,0,.25)" offset="100%"></stop>
                        </linearGradient>
                    </defs>
                    <path className="translate-x-0 translate-y-0 opacity-100" fill="url(#sw-gradient-wave-master-shadow)" d="M0,200L120,195.8C240,192,480,183,720,150C960,117,1200,58,1440,50C1680,42,1920,83,2160,95.8C2400,108,2640,92,2880,79.2C3120,67,3360,58,3600,66.7C3840,75,4080,100,4320,91.7C4560,83,4800,42,5040,29.2C5280,17,5520,33,5760,45.8C6000,58,6240,67,6480,95.8C6720,125,6960,175,7200,179.2C7440,183,7680,142,7920,116.7C8160,92,8400,83,8640,83.3C8880,83,9120,92,9360,91.7C9600,92,9840,83,10080,83.3C10320,83,10560,92,10800,83.3C11040,75,11280,50,11520,45.8C11760,42,12000,58,12240,75C12480,92,12720,108,12960,125C13200,142,13440,158,13680,158.3C13920,158,14160,142,14400,120.8C14640,100,14880,75,15120,70.8C15360,67,15600,83,15840,75C16080,67,16320,33,16560,25C16800,17,17040,33,17160,41.7L17280,50L17280,250L17160,250C17040,250,16800,250,16560,250C16320,250,16080,250,15840,250C15600,250,15360,250,15120,250C14880,250,14640,250,14400,250C14160,250,13920,250,13680,250C13440,250,13200,250,12960,250C12720,250,12480,250,12240,250C12000,250,11760,250,11520,250C11280,250,11040,250,10800,250C10560,250,10320,250,10080,250C9840,250,9600,250,9360,250C9120,250,8880,250,8640,250C8400,250,8160,250,7920,250C7680,250,7440,250,7200,250C6960,250,6720,250,6480,250C6240,250,6000,250,5760,250C5520,250,5280,250,5040,250C4800,250,4560,250,4320,250C4080,250,3840,250,3600,250C3360,250,3120,250,2880,250C2640,250,2400,250,2160,250C1920,250,1680,250,1440,250C1200,250,960,250,720,250C480,250,240,250,120,250L0,250Z"></path>
                </svg>
                <svg id="wave" className="rotate-0 duration-300" viewBox="0 0 1440 250" version="1.1" xmlns="http://www.w3.org/2000/svg">
                    <defs>
                        <linearGradient id="sw-gradient-wave-master" x1="0" x2="0" y1="1" y2="0">
                            <stop stopColor="rgba(1, 101, 183, 1)" offset="0%"></stop>
                            <stop stopColor="rgba(1, 101, 183, 1)" offset="100%"></stop>
                        </linearGradient>
                    </defs>
                    <path className="translate-x-0 translate-y-0 opacity-100" fill="url(#sw-gradient-wave-master)" d="M0,200L120,195.8C240,192,480,183,720,150C960,117,1200,58,1440,50C1680,42,1920,83,2160,95.8C2400,108,2640,92,2880,79.2C3120,67,3360,58,3600,66.7C3840,75,4080,100,4320,91.7C4560,83,4800,42,5040,29.2C5280,17,5520,33,5760,45.8C6000,58,6240,67,6480,95.8C6720,125,6960,175,7200,179.2C7440,183,7680,142,7920,116.7C8160,92,8400,83,8640,83.3C8880,83,9120,92,9360,91.7C9600,92,9840,83,10080,83.3C10320,83,10560,92,10800,83.3C11040,75,11280,50,11520,45.8C11760,42,12000,58,12240,75C12480,92,12720,108,12960,125C13200,142,13440,158,13680,158.3C13920,158,14160,142,14400,120.8C14640,100,14880,75,15120,70.8C15360,67,15600,83,15840,75C16080,67,16320,33,16560,25C16800,17,17040,33,17160,41.7L17280,50L17280,250L17160,250C17040,250,16800,250,16560,250C16320,250,16080,250,15840,250C15600,250,15360,250,15120,250C14880,250,14640,250,14400,250C14160,250,13920,250,13680,250C13440,250,13200,250,12960,250C12720,250,12480,250,12240,250C12000,250,11760,250,11520,250C11280,250,11040,250,10800,250C10560,250,10320,250,10080,250C9840,250,9600,250,9360,250C9120,250,8880,250,8640,250C8400,250,8160,250,7920,250C7680,250,7440,250,7200,250C6960,250,6720,250,6480,250C6240,250,6000,250,5760,250C5520,250,5280,250,5040,250C4800,250,4560,250,4320,250C4080,250,3840,250,3600,250C3360,250,3120,250,2880,250C2640,250,2400,250,2160,250C1920,250,1680,250,1440,250C1200,250,960,250,720,250C480,250,240,250,120,250L0,250Z"></path>
                </svg>
                <MotionDiv initial="hidden" whileInView="show" viewport={{
                    once: true,
                    amount: .3
                    ...
                    }} className="text-white font-bold text-28 leading-8 lg:text-60 lg:leading-65">{t("masterTitle")}</MotionH4>
                    <MotionDiv variants={{
                        hidden: {
                            opacity: 0,
                            x: "-20px"
            ...
            <div className="relative -mt-32 md:-mt-48 lg:-mt-60 2xl:-mt-96">
                ...
                <MotionDiv initial="hidden" whileInView="show" viewport={{
                    ...
                    }} className="text-white font-bold text-28 leading-8 lg:text-60 lg:leading-65">{t("manteneursTitle")}</MotionH4>
                    <MotionDiv className="flex flex-col items-center gap-14">
                        ...
                        <MotionDiv variants={{
                            ...
                            <Image src={LogoAccenture} alt="Logotipo da empresa Accenture" fill />
                        </MotionDiv>
                        <MotionDiv variants={{
                            hidden: {
                                opacity: 0,
            ...
            <div className="relative -mt-24 md:-mt-40 lg:-mt-60 2xl:-mt-80">
                <svg id="wave-partners-shadow" className="rotate-0 duration-300 absolute -top-2" viewBox="0 0 1440 250" version="1.1" xmlns="http://www.w3.org/2000/svg">
                    <defs>
                        <linearGradient id="sw-gradient-wave-partners-shadow" x1="0" x2="0" y1="1" y2="0">
                            <stop stopColor="rgba(0,0,0,.25)" offset="0%"></stop>
                            <stop stopColor="rgba(0,0,0,.25)" offset="100%"></stop>
                        </linearGradient>
                    </defs>
                    <path className="translate-x-0 translate-y-0 opacity-100" fill="url(#sw-gradient-wave-partners-shadow)" d="M0,150L120,129.2C240,108,480,67,720,75C960,83,1200,142,1440,154.2C1680,167,1920,133,2160,112.5C2400,92,2640,83,2880,104.2C3120,125,3360,175,3600,175C3840,175,4080,125,4320,104.2C4560,83,4800,92,5040,91.7C5280,92,5520,83,5760,87.5C6000,92,6240,108,6480,116.7C6720,125,6960,125,7200,104.2C7440,83,7680,42,7920,45.8C8160,50,8400,100,8640,104.2C8880,108,9120,67,9360,50C9600,33,9840,42,10080,75C10320,108,10560,167,10800,195.8C11040,225,11280,225,11520,195.8C11760,167,12000,108,12240,95.8C12480,83,12720,117,12960,145.8C13200,175,13440,200,13680,179.2C13920,158,14160,92,14400,79.2C14640,67,14880,108,15120,137.5C15360,167,15600,183,15840,179.2C16080,175,16320,150,16560,137.5C16800,125,17040,125,17160,125L17280,125L17280,250L17160,250C17040,250,16800,250,16560,250C16320,250,16080,250,15840,250C15600,250,15360,250,15120,250C14880,250,14640,250,14400,250C14160,250,13920,250,13680,250C13440,250,13200,250,12960,250C12720,250,12480,250,12240,250C12000,250,11760,250,11520,250C11280,250,11040,250,10800,250C10560,250,10320,250,10080,250C9840,250,9600,250,9360,250C9120,250,8880,250,8640,250C8400,250,8160,250,7920,250C7680,250,7440,250,7200,250C6960,250,6720,250,6480,250C6240,250,6000,250,5760,250C5520,250,5280,250,5040,250C4800,250,4560,250,4320,250C4080,250,3840,250,3600,250C3360,250,3120,250,2880,250C2640,250,2400,250,2160,250C1920,250,1680,250,1440,250C1200,250,960,250,720,250C480,250,240,250,120,250L0,250Z"></path>
                </svg>
                <svg id="wave-partners" className="rotate-0 duration-300" viewBox="0 0 1440 250" version="1.1" xmlns="http://www.w3.org/2000/svg">
                    <defs>
                        <linearGradient id="sw-gradient-wave-partners" x1="0" x2="0" y1="1" y2="0">
                            <stop stopColor="rgba(10, 10, 10, 1)" offset="0%"></stop>
                            <stop stopColor="rgba(10, 10, 10, 1)" offset="100%"></stop>
                        </linearGradient>
                    </defs>
                    <path className="translate-x-0 translate-y-0 opacity-100" fill="url(#sw-gradient-wave-partners)" d="M0,150L120,129.2C240,108,480,67,720,75C960,83,1200,142,1440,154.2C1680,167,1920,133,2160,112.5C2400,92,2640,83,2880,104.2C3120,125,3360,175,3600,175C3840,175,4080,125,4320,104.2C4560,83,4800,92,5040,91.7C5280,92,5520,83,5760,87.5C6000,92,6240,108,6480,116.7C6720,125,6960,125,7200,104.2C7440,83,7680,42,7920,45.8C8160,50,8400,100,8640,104.2C8880,108,9120,67,9360,50C9600,33,9840,42,10080,75C10320,108,10560,167,10800,195.8C11040,225,11280,225,11520,195.8C11760,167,12000,108,12240,95.8C12480,83,12720,117,12960,145.8C13200,175,13440,200,13680,179.2C13920,158,14160,92,14400,79.2C14640,67,14880,108,15120,137.5C15360,167,15600,183,15840,179.2C16080,175,16320,150,16560,137.5C16800,125,17040,125,17160,125L17280,125L17280,250L17160,250C17040,250,16800,250,16560,250C16320,250,16080,250,15840,250C15600,250,15360,250,15120,250C14880,250,14640,250,14400,250C14160,250,13920,250,13680,250C13440,250,13200,250,12960,250C12720,250,12480,250,12240,250C12000,250,11760,250,11520,250C11280,250,11040,250,10800,250C10560,250,10320,250,10080,250C9840,250,9600,250,9360,250C9120,250,8880,250,8640,250C8400,250,8160,250,7920,250C7680,250,7440,250,7200,250C6960,250,6720,250,6480,250C6240,250,6000,250,5760,250C5520,250,5280,250,5040,250C4800,250,4560,250,4320,250C4080,250,3840,250,3600,250C3360,250,3120,250,2880,250C2640,250,2400,250,2160,250C1920,250,1680,250,1440,250C1200,250,960,250,720,250C480,250,240,250,120,250L0,250Z"></path>
                </svg>
                <MotionDiv initial="hidden" whileInView="show" viewport={{
                    once: true,
                    amount: .075
                    ...
                    }} className="text-white font-bold text-28 leading-8 lg:text-60 lg:leading-65">{t("partnersTitle")}</MotionH4>
                    <MotionDiv className="flex flex-col items-center gap-14">
                        <MotionDiv variants={{
                            hidden: {
                                opacity: 0,
                            ...
                            <Image src={LogoZenith} alt="Logotipo da empresa Zenith Inova" fill />
                        </MotionDiv>
                        <MotionDiv variants={{
                            hidden: {
                                opacity: 0,
                            ...
                            <Image src={LogoParatic} alt="Logotipo da empresa Pará Tic" fill />
                        </MotionDiv>
                        <MotionDiv variants={{
                            hidden: {
                                opacity: 0,
                            ...
                            <Image src={LogoVoxdata} alt="Logotipo da empresa Voxx Data" fill />
                        </MotionDiv>
                        <MotionDiv variants={{
                            hidden: {
                                opacity: 0,
                            ...
                            <Image src={LogoIdopter} alt="Logotipo da empresa IDopter Labs" fill />
                        </MotionDiv>
                        <MotionDiv variants={{
                            hidden: {
                                opacity: 0,
                        ...
                        <MotionDiv variants={{
                            ...
                            <Image src={LogoEduTech} alt="Logotipo da empresa Edu Tech" fill />
                        </MotionDiv>
                        <MotionDiv variants={{
                            hidden: {
                                opacity: 0,
                        ...
                        <MotionDiv variants={{
                            ...
                            <Image src={LogoEasyGestor} alt="Logotipo da empresa Easy Gestor" fill />
                        </MotionDiv>
                        <MotionDiv variants={{
                            hidden: {
                                opacity: 0,
                ...
                <svg id="wave-partners-end" className="rotate-180 duration-300" viewBox="0 0 1440 250" version="1.1" xmlns="http://www.w3.org/2000/svg">
                    <defs>
                        <linearGradient id="sw-gradient-wave-partners-end" x1="0" x2="0" y1="1" y2="0">
                            <stop stopColor="rgba(10, 10, 10, 1)" offset="0%"></stop>
                            <stop stopColor="rgba(10, 10, 10, 1)" offset="100%"></stop>
                        </linearGradient>
                    </defs>
            ...
            <MotionDiv initial="hidden" whileInView="show" viewport={{
                ...
                }} className="text-40 font-bold leading-[44px] md:text-60 md:leading-[66px] text-balance max-w-[24ch] md:max-w-none">{t("footerTitle")}</MotionSpan>
                <MotionP variants={{
                    hidden: {
                        opacity: 0,
                        x: "-20px"
