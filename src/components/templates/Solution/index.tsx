...
export function Solution({ project }: SolutionProps) {
  ...
  const ytURL = locale === 'en' ? project.links.youtube.en : project.links.youtube.pt
  ...
  return (
    <div className="flex flex-col items-center justify-center gap-[108px] w-full h-full pb-36 md:gap-[111px]pt-[calc(2.814rem+121px)] md:pt-[calc(6.6rem+121px)] lg:pt-[calc(5.19rem_+121px)] overflow-hidden">
    ...
    <div
      className={"flex flex-col w-full h-full items-center justify-center gap-6 mb-[108px] px-6 md:px-[65px] md:mb-[150px] lg:px-[265px] lg:mb-[230px]"}
    >
