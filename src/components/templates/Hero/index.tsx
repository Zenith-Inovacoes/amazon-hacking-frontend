...
export default function Hero() {
    ...
    return (
        ...
        >
            <Image src={HeroBG} alt='Imagem de Background da seção Hero' fill className='object-cover object-center md:object-left lg:object-center' priority quality={100}/>
