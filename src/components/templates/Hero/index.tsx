...
export default function Hero() {
    ...
    return (
        <section
            id={sections.hero}
            className="bg-[url('/images/Hero-Bg.png')] bg-cover bg-center bg-no-repeat relative pt-48 pb-64 lg:pb-72 xl:pb-80 2xl:pb-[410px] md:bg-left lg:bg-center h-[calc(100%+200px)]"
        >
