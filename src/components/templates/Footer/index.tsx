...
import TucupyLogo from "public/images/Tucupy-Logo.svg";
import CesupaLogo from "public/images/LogoCesupa.png";
...
const Waves = () => {
  return (
    <div className="relative z-[25] after:bg-primary-100 after:w-full bg-white after:h-2 after:absolute after:-bottom-1">
      <svg
      ...
      <footer id={sections.footer} className="bg-primary-100 relative z-10">
        <div className="flex flex-col justify-center items-center gap-9 max-w-72 mx-auto md:max-w-[548px] relative z-10 md:gap-14 lg:max-w-screen-2xl lg:flex-row lg:px-8 lg:justify-between lg:gap-4 xl:gap-10">
          {!isInSolutions ? (
            ...
            <div className="flex flex-col items-center justify-center gap-9 py-4 md:gap-16 lg:order-3">
              <div className="flex flex-col gap-6 items-center justify-center">
                ...
                <div className="flex gap-6">
                  <SocialMediaButton
                    variant="fill"
                    href="https://instagram.com/tucupytecnologia"
                  >
                    <Image
          ...
          <div className="relative w-full max-w-56 h-20 md:h-32 md:max-w-96 xl:h-36 lg:order-1 lg:flex-1">
            <Image src={CesupaLogo} alt="Logo do CESUPA" fill />
          </div>
          <Separator
            orientation="vertical"
            ...
            <div className="flex flex-col text-xs text-white font-normal items-center justify-center md:text-16 md:flex-row md:gap-2">
              ...
              <span>
                {t.rich("developedBy", {
                  ...
                  span: (text) => isInSolutions && <span>{text}</span>,
                  link: (text) => (
                    <Link
                      className="text-xs md:text-16 font-bold"
                      href="https://zenithinova.com.br"
