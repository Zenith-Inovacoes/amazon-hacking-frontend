...
const FirstWave = () => {
    return (
        <svg id="about-first-wave" className="rotate-0 duration-300 -mt-28 sm:-mt-36 md:-mt-48 lg:-mt-60 xl:-mt-80 2xl:-mt-[420px]" viewBox="0 0 1440 280" version="1.1" xmlns="http://www.w3.org/2000/svg">
            <defs><linearGradient id="about-first-wave-gradient" x1="0" x2="0" y1="1" y2="0">
                <stop stopColor="rgba(255, 255, 255, 1)" offset="0%"></stop>
                <stop stopColor="rgba(255, 255, 255, 1)" offset="100%"></stop>
            </linearGradient>
            </defs>
            <path className="translate-x-0 translate-y-0 opacity-100" fill="url(#about-first-wave-gradient)" d="M0,252L80,252C160,252,320,252,480,242.7C640,233,800,215,960,200.7C1120,187,1280,177,1440,186.7C1600,196,1760,224,1920,200.7C2080,177,2240,103,2400,98C2560,93,2720,159,2880,168C3040,177,3200,131,3360,121.3C3520,112,3680,140,3840,163.3C4000,187,4160,205,4320,182C4480,159,4640,93,4800,56C4960,19,5120,9,5280,37.3C5440,65,5600,131,5760,140C5920,149,6080,103,6240,112C6400,121,6560,187,6720,210C6880,233,7040,215,7200,214.7C7360,215,7520,233,7680,214.7C7840,196,8000,140,8160,98C8320,56,8480,28,8640,51.3C8800,75,8960,149,9120,177.3C9280,205,9440,187,9600,168C9760,149,9920,131,10080,140C10240,149,10400,187,10560,205.3C10720,224,10880,224,11040,196C11200,168,11360,112,11440,84L11520,56L11520,280L11440,280C11360,280,11200,280,11040,280C10880,280,10720,280,10560,280C10400,280,10240,280,10080,280C9920,280,9760,280,9600,280C9440,280,9280,280,9120,280C8960,280,8800,280,8640,280C8480,280,8320,280,8160,280C8000,280,7840,280,7680,280C7520,280,7360,280,7200,280C7040,280,6880,280,6720,280C6560,280,6400,280,6240,280C6080,280,5920,280,5760,280C5600,280,5440,280,5280,280C5120,280,4960,280,4800,280C4640,280,4480,280,4320,280C4160,280,4000,280,3840,280C3680,280,3520,280,3360,280C3200,280,3040,280,2880,280C2720,280,2560,280,2400,280C2240,280,2080,280,1920,280C1760,280,1600,280,1440,280C1280,280,1120,280,960,280C800,280,640,280,480,280C320,280,160,280,80,280L0,280Z"></path>
        </svg>
    )
}
            ...
            <div id="about" className="h-fit relative bg-white pt-24 before:w-full before:h-1 before:bg-white before:top-[-2px] before:left-0 before:absolute lg:pb-32 2xl:pt-0">
                ...
                <div className="flex flex-col gap-9 justify-between items-center max-w-screen-2xl mx-auto lg:flex-row">
                    <MotionDiv viewport={{
                        ...
                        }} className="text-40 font-bold text-black leading-44 text-center md:text-50 md:leading-62 lg:text-60 lg:text-left">{t("title")}</MotionH3>
                        <MotionP variants={{
                            hidden: {
                                opacity: 0,
                                x: "-20px"
                    ...
                    <MotionDiv initial={{ opacity: 0, y: 20 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true, amount: .5 }} transition={{ duration: .8, ease: "easeOut" }} className="w-full h-96 relative lg:w-[50%] lg:h-[400px]">
            ...
            <NumbersSection>
                ...
                <div className="flex gap-24 px-8 justify-center items-center max-w-screen-2xl mx-auto">
                    <MotionDiv viewport={{
                        ...
                        }} className="text-40 font-bold text-white leading-44 w-full text-center md:text-50 md:text-left md:leading-62 lg:text-60">{t("goalsTitle")}</MotionH3>
                        <MotionP variants={{
                            hidden: {
                                opacity: 0,
                                x: "-20px"
                    ...
                    <MotionDiv initial={{ opacity: 0, y: 20 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true, amount: .5 }} transition={{ duration: .8, ease: "easeOut" }} className="hidden md:block relative w-[40%] h-52 lg:h-80">
                ...
                <div className="relative z-10 max-w-[100vw] w-full mx-auto">
                    ...
                    <MotionDiv viewport={{
                        ...
                        <GoalCard variants={goalCardVariants} title={t("GoalCards.imersion.title")} image={AboutGoal1} altImage="Duas pessoas numa aventura">
                            {t.rich("GoalCards.imersion.description", {
                                colored: (chunks) => <b className="text-primary-100">{chunks}</b>
                            })}
                        </GoalCard>
                        <GoalCard variants={goalCardVariants} title={t("GoalCards.iteration.title")} image={AboutGoal2} altImage="Um homem e uma mulher apertando as mãos">
                            {t.rich("GoalCards.iteration.description", {
                                colored: (chunks) => <b className="text-primary-100">{chunks}</b>
                            })}
                        </GoalCard>
                        <GoalCard variants={goalCardVariants} title={t("GoalCards.innovation.title")} image={AboutGoal3} altImage="Um homem mexendo no celular">
                            {t.rich("GoalCards.innovation.description", {
                                colored: (chunks) => <b className="text-primary-100">{chunks}</b>
                            })}
                        </GoalCard>
                        <GoalCard variants={goalCardVariants} title={t("GoalCards.network.title")} image={AboutGoal4} altImage="Três pessoas conectadas">
                ...
                <div className="bg-black md:bg-transparent relative">
                    <div className="flex gap-16 max-w-screen-2xl w-full mx-auto px-8">
                        <div className="flex flex-1 pt-20 pb-20 flex-col gap-3 relative z-10 grid-cols-2 grid-rows-[1fr_1fr] md:grid lg:grid-cols-[1fr_auto] xl:grid-cols-2">
                            <NumberCard className="md:col-start-1 md:col-end-2 md:row-start-1 md:row-end-3" title={t("NumberCards.students")} slowStartAnimation={false} interval={10} number={240} image={AboutNumber1} altImage="Ícone de um usuário" />
                            <NumberCard title={t("NumberCards.teams")} number={30} image={AboutNumber2} altImage="Ícone de vários usuários" />
                            <NumberCard title={t("NumberCards.mentors")} number={25} image={AboutNumber3} altImage="Ícone de vários executivos" />
                            <Image src={AboutNumberPlant} alt="Planta" className="hidden lg:block absolute bottom-4 -left-8 z-10" height={248} width={160} />
                        </div>
                        <MotionDiv initial={{ opacity: 0, y: 20 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true, amount: .5 }} transition={{ duration: .8, ease: "easeOut" }} className="relative hidden lg:block w-[30%] translate-y-6">
