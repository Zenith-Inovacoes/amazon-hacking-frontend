...
const Logged = ({ name, email, image, ...props }: LoggedMenuProps) => {
  ...
  return (
    <Dialog.Root open={open} onOpenChange={handleOpenChange}>
      <Dialog.Trigger className='absolute w-fit h-fit right-0 top-0 z-50 transition-opacity duraiton-200 ease-linear data-[state=open]:opacity-0 mr-4 xs:mr-[42px] md:mr-[62px] mt-9 lg:hidden'>
        <IoMenu size={46} />
      </Dialog.Trigger>
      <Dialog.Portal>
