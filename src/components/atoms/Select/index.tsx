  ...
  (
    ...
    return (
      <SelectPrimitive.Item
        ref={ref}
        className={cn(
          'text-black font-bold bg-white leading-4 px-4 py-3 text-base hover:bg-neutrals-300 active:bg-neutrals-400 focus-visible:bg-neutrals-300 focus-visible:outline-none transition-colors data-[state=checked]:hidden data-[state=checked]:absolute data-[state=checked]:opacity-0',
          className
        )}
        {...props}
      >
