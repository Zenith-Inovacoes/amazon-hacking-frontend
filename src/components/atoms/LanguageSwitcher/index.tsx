      ...
      >
        ...
        <SelectPrimitive.Portal>
          <SelectPrimitive.Content
            className='min-w-[var(--radix-select-trigger-width)] shadow-languageSwitcher cursor-pointer'
            position='popper'
          >
            <SelectPrimitive.Viewport>
              {locales.map((locale, index) => (
                <SelectPrimitive.Item
                  key={index}
                  value={locale.locale}
                  className='font-normal text-base leading-4 px-3 py-2 bg-neutrals-600 focus-visible:outline-none hover:bg-neutrals-700 focus-visible:bg-neutrals-700 transition-colors data-[state=checked]:hidden'
                >
